...
network_files = ['new_choice_network_0.03/new_1000_network_choice_1', 'new_choice_network_0.03/new_1000_network_choice_2', 'new_choice_network_0.03/new_1000_network_choice_3','new_choice_network_0.03/new_1000_network_choice_4','new_choice_network_0.03/new_1000_network_choice_5','new_choice_network_0.03/new_1000_network_choice_6','new_choice_network_0.03/new_1000_network_choice_7','new_choice_network_0.03/new_1000_network_choice_8','new_choice_network_0.03/new_1000_network_choice_9','new_choice_network_0.03/new_1000_network_choice_10']
networks = []
...
for i,j,d in G.edges(data=True):
    ...
    #gets the i node values (X_i)
    
    a_i = G.nodes[i]["a"]
    h_i = G.nodes[i]["h"]
    c_i = G.nodes[i]["c"]
    #gets the j node values (Y_j)
...
file_exists = os.path.isfile('combined_new_assortativity_choice.csv')
with open('combined_new_assortativity_choice.csv', mode='a') as csv_file:
