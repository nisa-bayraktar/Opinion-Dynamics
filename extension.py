...
G = pickle.load(open('normal_network_0.3/1000_network_normal_1_1', 'rb'))
...
for n in range (len(UG.nodes)):
        ...
        file_exists = os.path.isfile('1000_network_normal_0.3.csv')

        with open('1000_network_normal_0.3.csv', mode='a') as csv_file:
