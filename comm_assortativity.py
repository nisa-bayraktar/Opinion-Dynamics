...
G = pickle.load(open('new_uniform_network_0.03/new_1000_network_uniform_2', 'rb'))
...
file_exists = os.path.isfile('comm_assortativity_uniform.csv')
with open('comm_assortativity_uniform.csv', mode='a') as csv_file:
